...
Let $\Delta$ denote the set of atomic execution events. An event is the smallest unit that participates in ordering within the execution stream. Events are the atomic elements of $V$; no sub-event structure is assumed. For the purposes of replay and projection, events are treated as indivisible. An event may carry an observation payload.
