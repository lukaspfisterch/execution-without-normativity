...
All results in this section and the next follow directly from the axioms and are included only to make the invariant structure explicit.
...
\paragraph{Proposition 6.4 (Observational non-interference).}
