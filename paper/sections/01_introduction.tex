...
This paper presents formal foundations, axioms, and proof sketches of observational non-interference and replay equivalence. The results are purely structural and apply to any system that can produce an ordered stream of execution events.
