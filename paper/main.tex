...
\author{Lukas Pfister\\Independent Researcher\\Zurich, Switzerland\\\texttt{github.com/lukaspfisterch}}
\date{March 2026}
...
\input{sections/02_scope_non_goals}
\input{sections/03_conceptual_foundations}
\input{sections/04_formal_model}
\input{sections/05_axioms}
\input{sections/06_observational_non_interference}
\input{sections/07_replay_equivalence}
\input{sections/08_implications}
